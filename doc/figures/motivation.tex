...
\begin{tikzpicture}
    ...
    \node [right=1cm of m1.north, anchor=south, circle, draw, fill=base3] (me) { };
    ...
    \node [left=2mm of m1, fill=base3, inner sep=0pt, align=right] {methylation};
    \node [left=5mm of a1, fill=base3, inner sep=0pt, text width=2cm,
    align=right] {histone \\ acetylation};
    \node [left=5mm of g.west, fill=base3, inner sep=0pt, align=right] {genotype};
\end{tikzpicture}
